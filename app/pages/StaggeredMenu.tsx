...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    ...
    return (
        <div
            className={(className ? className + '' : 'z-60') + 'staggered-menu-wrapper z-60' + (isFixed ? ' fixed-wrapper' : '')}
        ...
        >
            ...
            <header className="staggered-menu-header" aria-label="Main navigation header">
                <div className="sm-logo" aria-label="Logo">
                    <svg width="50" height="40" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg">
